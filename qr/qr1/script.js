...
function init() {
  ...
  add.addEventListener('click', () => {
    content.insertBefore(createQR('https://github.com/hraqrb3904/www/blob/master/README.md?r#1'), add)
  });
  ...
  let localQr = JSON.parse(localStorage.getItem('_local_qr_codes_') || '["https://github.com/hraqrb3904/www/blob/master/README.md?r#1"]');
